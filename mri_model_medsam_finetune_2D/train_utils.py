...
def load_encoder_only(model, ckpt_path: Path, prefix="encoder."):
    ...
    if missing:   print(f"[load_encoder_only] Missing keys in encoder: {missing}")
    if unexpected:print(f"[load_encoder_only] Unexpected keys in encoder: {unexpected}")
